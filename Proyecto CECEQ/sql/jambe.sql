...
(1, 'Consultar Actividades', 'Acceder a la interfaz que de “ Actividades” y visualizar las actividades agendadas por CECEQ.'),
(2, 'Consultar catálogo de libros', '\r\nPoder consultar el catálogo de libros donde se enlistan todos los ejemplares existentes. (Excepto los de estado en descarte)\r\n'),
(3, 'Editar ejemplar', '\r\nEditar los datos de un ejemplar.\r\n'),
(4, 'Agregar ejemplar', '\r\nAgregar un ejemplar al sistema.\r\n'),
(5, ' Eliminar ejemplares', 'Cambiar el estado de un libro al estado En Descarte.'),
(6, 'Registrar entrada', '\r\nRegistrar la entrada de cualquier visitante a la biblioteca.\r\n'),
(7, ' Gestionar Credenciales', '\r\nLlenar el formulario de credencial para un visitante que está solicitando una credencial e imprimirla.'),
(8, ' Buscar visitante', '\r\nObtener la información completa de un visitante buscandolo por alguno de los campos desplegados en la interfaz.\r\n'),
(9, ' Editar visitante', '\r\nModificar la información asociada con un visitante tanto con credencial o sin credencial.\r\n'),
(10, ' Generar estadísticas', '\r\nConsultar los reportes de la biblioteca a través de gráficas estadísticas y tener opción de imprimirlas.'),
(11, ' Generar reporte de DGB', '\r\nGenerar un reporte con algunos de los datos que pide el reporte DGB. Y tiene la opción de exportar los datos a un documento de Excel.'),
(12, 'Registrar préstamo y devolución de libro (s)', 'Registrar el préstamo y devolución de un libro a un visitante con credencial.'),
(13, 'Imprimir códigos de barras', 'Imprimir el código de barras de un ejemplar.'),
(14, ' Consultar cuentas de cuentahabientes', '\r\n\r\nObtener la información de cualquier cuenta.Además de visualizar el listado de todas las cuentas existentes.'),
(15, ' Consultar visitantes con sanciones', '\r\nConsultar la lista de visitantes sancionados.'),
(16, ' Agregar sanción a visitante', '\r\nAgregar una sanción a un visitante.'),
(17, ' Quitar sanción a visitante', '\r\nEliminar la sanción de un visitante.\r\n'),
(18, ' Importar libros desde Excel.', '\r\nImportar libros al sistema desde un archivo de Excel.'),
(19, ' Agregar cuenta', '\r\nDar de alta a un cuentahabiente para que pueda acceder al sistema. '),
(20, ' Eliminar cuenta', '\r\nEditar el perfil de un cuentahabiente. Todos los campos son editables excepto el nombre de usuario.\r\n'),
(21, ' Editar cuenta', '\r\nEditar el perfil de un cuentahabiente. Todos los campos son editables excepto el nombre de usuario.'),
(22, ' Consultar roles', '\r\nConsultar los roles que han sido creados.'),
(23, ' Agregar rol', '\r\nSe crea un nuevo rol. Por ejemplo, Asistente de biblioteca y se seleccionan todos los permisos que se desean incluir en dicho rol.'),
(24, ' Quitar rol', '\r\nSe elimina un rol del sistema.\r\n'),
(25, ' Editar rol', '\r\nEdita atributos del rol. Como nombre o descripción.\r\n'),
(26, ' Exportar libros a Excel', '\r\nExportar a un documento de excel la lista de todos los ejemplares.\r\n');
